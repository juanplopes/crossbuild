...
This is a fork from [multiarch/crossbuild](https://github.com/multiarch/crossbuild) created to support macOS M1 chips.
...
aarch64-apple-darwin   | arm64-apple-darwin, osx64arm        |       |  X  |
...
```console
$ docker run --rm -v $(pwd):/workdir juanplopes/crossbuild make helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir juanplopes/crossbuild cc test/helloworld.c
```

#### arm

```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=arm-linux-gnueabi juanplopes/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=arm-linux-gnueabihf juanplopes/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=powerpc64le-linux-gnu juanplopes/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=aarch64-linux-gnu juanplopes/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=mipsel-linux-gnu juanplopes/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=i386-apple-darwin  juanplopes/crossbuild make helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=aarch64-apple-darwin  juanplopes/crossbuild make helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=x86_64-apple-darwin  juanplopes/crossbuild make helloworld
o64-clang     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=i686-w64-mingw32  juanplopes/crossbuild make helloworld
o32-clang     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=x86_64-w64-mingw32  juanplopes/crossbuild make helloworld
o64-clang     helloworld.c   -o helloworld
$ file helloworld
